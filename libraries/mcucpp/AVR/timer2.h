...
#       define ControlRegB TCCR2B
...
#if defined (WGM20) && !defined(WGM22)
	...
	{		
		...
		enum TimerMode
		{
			...
			PwmPhaseCorrect = (0 << WGM22) | (0 << WGM21) | (1 << WGM20),
			ClearOnMatch 	= (0 << WGM22) | (1 << WGM21) | (0 << WGM20),
			PwmFast 		= (0 << WGM22) | (1 << WGM21) | (1 << WGM20),
			//Reserved1		= (1 << WGM22) | (0 << WGM21) | (0 << WGM20),
			PwmPhaseCorrectToOCRA = (1 << WGM22) | (0 << WGM21) | (1 << WGM20),
			//Reserved2 	= (1 << WGM22) | (1 << WGM21) | (2 << WGM20),
			PwmFastToOCRA	= (1 << WGM22) | (1 << WGM21) | (1 << WGM20),
		};

		enum {TimerModeAClearMask = ~((1 << WGM21) | (1 << WGM20))};
		enum {TimerModeAMask = ((1 << WGM21) | (1 << WGM20))};
		enum {TimerModeBClearMask = ~((1 << WGM22))};
		enum {TimerModeBMask = ~((1 << WGM22))};
	...
	template<> class Timer2::OutputCompare<1>
	{
	public:
		static void Set(DataT val)
		{
		...
		static void EnableInterrupt()
		{
			InterruptMaskReg |= (1 << OCIE2B);
		}

		static bool IsInterrupt()
		{
			return InterruptFlagsReg & (1<<OCF2B);
		}
	
		static void ClearInterruptFlag()
		{
			InterruptFlagsReg |= (1<<OCF2B);
		}
	};
